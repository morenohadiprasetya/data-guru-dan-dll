...
if (
  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-56 bg-blue-900/95 backdrop-blur-xl
                    text-white shadow-2xl border-r border-blue-800 flex flex-col justify-between z-50">
      ...
      <div>
        <div
          ...
          className="flex items-center justify-center gap-2 text-xl font-bold py-4
                     bg-blue-800/40 hover:bg-blue-700/40 cursor-pointer border-b border-blue-700"
        >
        ...
        <nav className="flex flex-col mt-4 px-3 space-y-2">
          ...
          >
            ...
            <i className={`ri-arrow-down-s-line ${openDatabase ? "rotate-180" : ""}`}></i>
          </button>

          {openDatabase && (
            <div className="ml-7 flex flex-col gap-1 text-sm">
              <Link to="/kategori-data" className="py-1 flex gap-2 text-white">
                <i className="ri-price-tag-3-line"></i> Kategori Data
              </Link>
              <Link to="/kelas" className="py-1 flex gap-2 text-white">
                <i className="ri-building-2-line"></i> Kelas
              </Link>
              <Link to="/Masterdata" className="py-1 flex gap-2 text-white">
          ...
          >
            ...
            <i className={`ri-arrow-down-s-line ${openKeuangan ? "rotate-180" : ""}`}></i>
          </button>

          {openKeuangan && (
            <div className="ml-7 flex flex-col gap-1 text-sm">
              <Link to="/kategori-tagihan" className="py-1 flex gap-2 text-white">
                <i className="ri-list-check-2"></i> Kategori Tagihan
              </Link>
              <Link to="/tagihan" className="py-1 flex gap-2 text-white">
      ...
      <div className="p-4">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-red-600
                     hover:bg-red-700 text-white py-2 rounded shadow-md"
        >
